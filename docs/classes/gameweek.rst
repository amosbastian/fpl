...
An example of what information a :class:`Gameweek <fpl.models.gameweek.Gameweek>` is too large to show, so it is recommended you
check about the above two endpoints yourself to get an idea.
